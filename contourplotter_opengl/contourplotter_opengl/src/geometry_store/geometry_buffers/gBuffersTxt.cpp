#include "gBuffersTxt.h"

gBuffersTxt::gBuffersTxt()
{
	// Empty constructor
}
...
void gBuffersTxt::CreateBuffers(const float* vb_data, unsigned int& vb_size,
...
void gBuffersTxt::CreateDynamicBuffers(unsigned int& vb_size,
...
void gBuffersTxt::UpdateDynamicVertexBuffer(const float* vb_data,
