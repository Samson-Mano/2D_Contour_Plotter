...
std::string geom_parameters::format_displacement_string(double value)
{
	...
	// Format the value with the calculated decimal places
	ss << std::fixed << std::setprecision(10) << value;
	result = ss.str();

	// Ensure the string does not exceed 10 characters (trim if necessary)
	if (result.length() > 10)
	{
...
glm::vec3 geom_parameters::get_standard_color(int color_index)
{
	...
	static const std::vector<glm::vec3> StandardColors =
	{
		// Blue variants
		ColorToVec3(0, 0, 255),           // Blue
		ColorToVec3(138, 43, 226),        // BlueViolet
		ColorToVec3(165, 42, 42),         // Brown
		ColorToVec3(222, 184, 135),       // BurlyWood
		ColorToVec3(95, 158, 160),        // CadetBlue
		ColorToVec3(210, 105, 30),        // Chocolate
		ColorToVec3(255, 127, 80),        // Coral
		ColorToVec3(100, 149, 237),       // CornflowerBlue
		ColorToVec3(220, 20, 60),         // Crimson
		ColorToVec3(0, 0, 139),           // DarkBlue
		ColorToVec3(0, 139, 139),         // DarkCyan
		ColorToVec3(184, 134, 11),        // DarkGoldenrod
		ColorToVec3(0, 100, 0),           // DarkGreen
		ColorToVec3(189, 183, 107),       // DarkKhaki
		ColorToVec3(139, 0, 139),         // DarkMagenta
		ColorToVec3(85, 107, 47),         // DarkOliveGreen
		ColorToVec3(255, 140, 0),         // DarkOrange
		ColorToVec3(153, 50, 204),        // DarkOrchid
		ColorToVec3(139, 0, 0),           // DarkRed
		ColorToVec3(233, 150, 122),       // DarkSalmon
		ColorToVec3(143, 188, 143),       // DarkSeaGreen
		ColorToVec3(72, 61, 139),         // DarkSlateBlue
		ColorToVec3(47, 79, 79),          // DarkSlateGray
		ColorToVec3(0, 206, 209),         // DarkTurquoise
		ColorToVec3(148, 0, 211),         // DarkViolet
		ColorToVec3(255, 20, 147),        // DeepPink
		ColorToVec3(0, 191, 255),         // DeepSkyBlue
		ColorToVec3(30, 144, 255),        // DodgerBlue
		ColorToVec3(178, 34, 34),         // Firebrick
		ColorToVec3(34, 139, 34),         // ForestGreen
		ColorToVec3(255, 0, 255),         // Fuchsia
		ColorToVec3(218, 165, 32),        // Goldenrod
		ColorToVec3(0, 128, 0),           // Green
		ColorToVec3(255, 105, 180),       // HotPink
		ColorToVec3(205, 92, 92),         // IndianRed
		ColorToVec3(75, 0, 130),          // Indigo
		ColorToVec3(240, 230, 140),       // Khaki
		ColorToVec3(240, 128, 128),       // LightCoral
		ColorToVec3(255, 160, 122),       // LightSalmon
		ColorToVec3(32, 178, 170),        // LightSeaGreen
		ColorToVec3(135, 206, 250),       // LightSkyBlue
		ColorToVec3(176, 196, 222),       // LightSteelBlue
		ColorToVec3(50, 205, 50),         // LimeGreen
		ColorToVec3(255, 0, 255),         // Magenta
		ColorToVec3(128, 0, 0),           // Maroon
		ColorToVec3(102, 205, 170),       // MediumAquamarine
		ColorToVec3(0, 0, 205),           // MediumBlue
		ColorToVec3(186, 85, 211),        // MediumOrchid
		ColorToVec3(147, 112, 219),       // MediumPurple
		ColorToVec3(60, 179, 113),        // MediumSeaGreen
		ColorToVec3(123, 104, 238),       // MediumSlateBlue
		ColorToVec3(72, 209, 204),        // MediumTurquoise
		ColorToVec3(199, 21, 133),        // MediumVioletRed
		ColorToVec3(25, 25, 112),         // MidnightBlue
		ColorToVec3(0, 0, 128),           // Navy
		ColorToVec3(128, 128, 0),         // Olive
		ColorToVec3(107, 142, 35),        // OliveDrab
		ColorToVec3(255, 165, 0),         // Orange
		ColorToVec3(255, 69, 0),          // OrangeRed
		ColorToVec3(218, 112, 214),       // Orchid
		ColorToVec3(219, 112, 147),       // PaleVioletRed
		ColorToVec3(205, 133, 63),        // Peru
		ColorToVec3(128, 0, 128),         // Purple
		ColorToVec3(255, 0, 0),           // Red
		ColorToVec3(188, 143, 143),       // RosyBrown
		ColorToVec3(65, 105, 225),        // RoyalBlue
		ColorToVec3(139, 69, 19),         // SaddleBrown
		ColorToVec3(250, 128, 114),       // Salmon
		ColorToVec3(244, 164, 96),        // SandyBrown
		ColorToVec3(46, 139, 87),         // SeaGreen
		ColorToVec3(160, 82, 45),         // Sienna
		ColorToVec3(135, 206, 235),       // SkyBlue
		ColorToVec3(106, 90, 205),        // SlateBlue
		ColorToVec3(112, 128, 144),       // SlateGray
		ColorToVec3(70, 130, 180),        // SteelBlue
		ColorToVec3(210, 180, 140),       // Tan
		ColorToVec3(0, 128, 128),         // Teal
		ColorToVec3(216, 191, 216),       // Thistle
		ColorToVec3(255, 99, 71),         // Tomato
		ColorToVec3(64, 224, 208),        // Turquoise
		ColorToVec3(238, 130, 238),       // Violet
		ColorToVec3(245, 222, 179),       // Wheat
		ColorToVec3(255, 255, 0),         // Yellow
		ColorToVec3(154, 205, 50)         // YellowGreen
	};


	int index = color_index % StandardColors.size();
...
glm::vec3 geom_parameters::ColorToVec3(float r, float g, float b)
{
